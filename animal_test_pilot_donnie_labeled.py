...
boris_files = sorted(glob('./boris_training_annotations/donnie_initial/*.csv'))
...
save_sklearn_model(model, './analysis/xgb_model_all_training_donnie_labeled.pkl')
...
dataset.save('./analysis/dataset_training_donnie_labeled.pkl')
test_dataset.save('./analysis/dataset_test_donnie_labeled.pkl')

#Make videos of performance in training data
dataset.make_movie({'label':'invest.', 'prediction':'predicted invest.'}, './analysis/videos/training_donnie_labeled/')

#Make videos of predictions in test data
test_dataset.make_movie({'prediction':'predicted invest.'}, './analysis/videos/test_donnie_labeled/')